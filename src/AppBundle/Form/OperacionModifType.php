...
class OperacionModifType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('folio')
            ...
            ->add('salon', TextType::class, array('label' => 'Salón'))
...
//            ->add('clasifOperTipo2Fk')
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'AppBundle\Entity\OperacionModif'
        ));
    }
    ...
    {
        return 'appbundle_operacionmodif';
    }
