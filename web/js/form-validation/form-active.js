 ...
 // Validation for order form
		...
		{					
			...
			{	
				...
				address:
				{
					required: 'Por favor entre su direccion'
				},
				department:
				{
					required: 'Por favor entre el departamento'
				},
				postcode:
				{
				...
				description:
				{
					required: 'Por favor entre la descripción'
				},
				gender:
				{
 ...
 // Validation for order form
		...
		{					
			...
			{	
				...
				confarmpassword:
				{
					required: 'Por favor entre su contraseña de confirmación'
				}
